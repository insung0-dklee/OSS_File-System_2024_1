...
def file_edit():
    ...
    while not finish:
        ...
        select = input("파일 편집 기능을 실행합니다. 원하는 세부 기능을 입력하세요. ('?' 입력시 도움말)")

        if select == '?':
            print(" [도움말]")
            print(" '읽기'              입력시 해당 파일의 내용을 출력합니다.")
            print(" '파일 생성 및 쓰기'  입력시 파일을 생성하고 원하는 내용을 작성합니다.")
            print(" '종료'              입력시 파일 편집 기능을 종료할 수 있습니다.")
        elif select == "읽기":
            read_file()
